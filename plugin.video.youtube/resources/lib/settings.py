...
class Settings(CommonSettings):
    ...
    FALLBACK_YOUTUBE_APK = Bool('fallback_youtube_apk', _.FALLBACK_NATIVE_APK, default=True, visible=lambda: sys.version_info[0] > 2 and not Settings.PLAY_WITH_NATIVE_APK.value and xbmc.getCondVisibility('system.platform.android'))
