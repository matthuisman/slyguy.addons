...
def strtol(value, convert=float):
    try:
        ...
        match = re.match('^[0-9]+', value.strip())
        if not match:
            return 0
...
class _ListItemInfoTagVideo(_ListItemInfoTag):
    ...
    _tag_attr = {
        ...
        'episode': {'attr': 'setEpisode', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        'season': {'attr': 'setSeason', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        'sortepisode': {'attr': 'setSortEpisode', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        'sortseason': {'attr': 'setSortSeason', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        ...
        'top250': {'attr': 'setTop250', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        'setid': {'attr': 'setSetId', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        'tracknumber': {'attr': 'setTrackNumber', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        'rating': {'attr': 'setRating', 'convert': lambda x: strtol(x, float), 'classinfo': float},
        'userrating': {'attr': 'setUserRating', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        'watched': {'skip': True},  # Evaluated internally in Nexus based on playcount so skip
        'playcount': {'attr': 'setPlaycount', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        ...
        'duration': {'attr': 'setDuration', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        ...
        'votes': {'attr': 'setVotes', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        ...
        'dbid': {'attr': 'setDbId', 'convert': lambda x: strtol(x, int), 'classinfo': int},
    }
...
class _ListItemInfoTagMusic(_ListItemInfoTag):
    ...
    _tag_attr = {
        ...
        'tracknumber': {'attr': 'setTrack', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        'discnumber': {'attr': 'setDisc', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        'duration': {'attr': 'setDuration', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        'year': {'attr': 'setYear', 'convert': lambda x: strtol(x, int), 'classinfo': int},
        'genre': {'attr': 'setGenres', 'convert': lambda x: [x], 'classinfo': (list, tuple)},
        'album': {'attr': 'setAlbum', 'convert': str, 'classinfo': str},
        ...
        'listeners': {'attr': 'setListeners', 'convert': lambda x: strtol(x, int), 'classinfo': int},
