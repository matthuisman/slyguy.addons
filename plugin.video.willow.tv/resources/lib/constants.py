...
# COUNTRY_CODE_URL   = 'http://linsoftlayer.willow.tv/getCC.php'
# HIGHLIGHTS_URL     = 'http://appfeeds.willow.tv/OttTrendingHighlights_{country_code}.json'
TEAMS_IMAGE_URL    = 'https://aimages.willow.tv/AppleTvLogos/{team1}_{team2}.png' #.replace(" ","")
