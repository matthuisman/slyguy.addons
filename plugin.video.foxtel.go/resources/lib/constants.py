...
LEGACY_URL = 'https://foxtel-go-sw.foxtelplayer.foxtel.com.au/go-mobile-440'
EPG_URL = LEGACY_URL + '/api/epg.class.api.php/getChannelListings/' + LIVE_SITEID
LICENSE_URL = LEGACY_URL + '/api/playback.class.api.php/{endpoint}/{site_id}/1/{id}'
